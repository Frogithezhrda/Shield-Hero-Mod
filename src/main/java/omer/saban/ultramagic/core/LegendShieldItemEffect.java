...
public class LegendShieldItemEffect extends SwordItem {
	   public LegendShieldItemEffect(Properties p_43089_) {
...
public void inventoryTick(ItemStack p_41404_, Level p_41405_, Entity entity, int p_41407_, boolean p_41408_) {
    ...
    if(player.getMainHandItem() != null && player.getMainHandItem().getItem() instanceof LegendShieldItemEffect) {
