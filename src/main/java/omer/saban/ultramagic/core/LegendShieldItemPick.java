...
public class LegendShieldItemPick extends PickaxeItem {

	   public LegendShieldItemPick(Tier lEGEND, int i, int j, Properties p_43089_) {
		super(ToolMaterialInit.LEGEND, 6, -1, p_43089_);
	...
	@Override
	   ...
	   public void inventoryTick(ItemStack p_41404_, Level p_41405_, Entity entity, int p_41407_, boolean p_41408_) {
	       ...
	       if(player.getMainHandItem() != null && player.getMainHandItem().getItem() instanceof LegendShieldItemPick) {
